...
function markupPages(array) {
  let pagesBtnMarkup = `     <div class="page_item">
        <a href="#" class="page_link pagination_btn" data-page=${array.page - 2}>${
    array.page - 2
  }</a>
      </div>
      <div class="page_item ${array.page - 1 <= 0 ? 'visually-hidden' : ''}">
        <a href="#" class="page_link pagination_btn" data-page=${array.page - 1}>${
    array.page - 1
  }</a>
      </div>
      <div class="page_item disabled">
        <a href="#" class="page_link pagination_btn btn_active btn_disabled" data-page=${
          array.page
        }>${array.page}</a>
      </div>
      <div class="page_item">
  ...
  if (window.innerWidth > 767) {
    pagesBtnMarkup = `
      <li class="page_item"><a href="#" class="page_link pagination_btn" data-page=${
        array.page - 1
      }>${array.page - 1}</a></li>
              <li class="page_item disabled"><a href="#" class="page_link pagination_btn btn_active btn_disabled" data-page=${
                array.page
              }>${array.page}</a></li>
              <li class="page_item"><a href="#" class="page_link pagination_btn" data-page=${
                array.page + 1
